...
mod u8 {
    ...
    fn write_u8_to_u8s() {
        let mut to: [u8; 12] = [
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
        ];
        let from: [u8; 2] = [255, 0];
        ...
        let _ = bcurs.write(&from).unwrap();
        let equals: [u8; 12] = [
            0b11111111, 0b00000000, 0b10001000, 0b01101010,
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
        ];
        assert_eq!(&equals[..], &bcurs.get_ref()[..]);
        ...
        let _ = bcurs.write(&from[..]).unwrap();
        let equals: [u8; 12] = [
            0b11111111, 0b00000000, 0b10001000, 0b01111111,
            0b11000000, 0b00100101, 0b10001000, 0b01101010,
            0b10010010, 0b00100101, 0b10001000, 0b01101010,
        ];
        assert_eq!(&equals[..], &bcurs.get_ref()[..]);
    }
